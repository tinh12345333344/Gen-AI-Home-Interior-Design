...
# # ✅ Load VGG16 model once at startup
...
#             raise HTTPException(
#                 status_code=400,
#                 detail=f"Unsupported file type for place_image: {place_image.content_type}",
#             )

#         place_bytes = await place_image.read()
#         size_in_mb = len(place_bytes) / (1024 * 1024)
#         if size_in_mb > MAX_IMAGE_SIZE_MB:
#             raise HTTPException(status_code=400, detail="Image exceeds 10MB size limit for place_image")

#         place_b64 = array_buffer_to_base64(place_bytes)

#         # ✅ Phân tích bằng VGG16
#         vgg16_analysis = analyze_with_vgg16(place_bytes)

#         # ✅ Thêm thông tin phân tích vào prompt
#         prompt = f"""
#         You are a professional AI interior and exterior designer.
#         Your task is to redesign a user's uploaded space.
...
#                 "image": image_url,
#                 "text": text_response,
#                 "vgg16_analysis": vgg16_analysis,  # ✅ trả thêm kết quả VGG16
#             }
#         )
